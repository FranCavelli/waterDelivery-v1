            ...
            <div class="col-md-4">
                ...
                <div class="tarjeta">
                    <form action="php/crud/saveTask.php" method="POST">
                        ...
                        <div class="form-group">
                            <select name="reparto" placeholder="Reparto" class="selectDiaReparto" required>
                                <option disabled="">Reparto:</option>
                                <option value="Lunes">1 - Lunes</option>
                                <option value="Lunes2">2 - Lunes(2)</option>
                                <option value="Ruta">3 - Ruta</option>
                                <option value="Martes">4 - Martes</option>
                                <option value="Martes2">5 - Martes(2)</option>
                                <option value="Martes3">6 - Martes(3)</option>
                                <option value="Miercoles">7 - Miercoles</option>
                                <option value="Ex Gagliano">8 - Ex gagliano</option>
                                <option value="Jueves">9 - Jueves</option>
                                <option value="Jueves2">10 - Jueves(2)</option>
                                <option value="Javier Jueves">11 - Jueves Javier</option>
                                <option value="Viernes">12 - Viernes</option>
                                <option value="Viernes2">13 - Viernes(2)</option>
                                <option value="Viernes Otro">14 - Viernes otro</option>
                                <option value="Sabado">15 - Sabado</option>
                                <option value="Javier Sabado">16 - Sabado Javier</option>
                                <option value="Agustin">17 - Agustin</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <select name="reparto2" placeholder="Reparto2" class="selectDiaReparto">
                                <option disabled="">Reparto 2:</option>
                                <option value="">Ninguno</option>
                                <option value="Lunes">1 - Lunes</option>
                                <option value="Ruta">2 - Ruta</option>
                                <option value="Martes">3 - Martes</option>
                                <option value="Martes2">4 - Martes(2)</option>
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="clientesVerBoton.php?id=<?php echo $row['numeroCliente'] ?>" class="botonVer"><i style="margin-left:10px;" class="fa-solid fa-eye"></i></a>
