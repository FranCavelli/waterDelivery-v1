...
<link rel="stylesheet" type="text/css" href="stylesGastos.css">
    <div class="container">
        <div class="EditarClientesTitulo"><i class="fa-solid fa-money-bill"></i> Editar gastos - <?php echo $fechaBuscada;?></div>
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="tarjetaProductos">
                    <form action="php/crud/saveTaskGastos.php" method="POST">
                        <div class="form-group">
                            <input type="text" placeholder="Nombre" name="nombre" autofocus>
                        </div>
                        <div class="form-group">
                ...
                <div class="tarjetaFechaGastos">
                    <form action="buscarTaskGastosFecha.php" method="POST">
                        <div class="form-group">
                            <input type="date" value="<?php echo $fechaBuscada?>" name="fecha">
                        </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_procutos FROM `gastos` WHERE fecha='$fechaBuscada'");
                                ...
                                $query = "SELECT * FROM gastos WHERE fecha='$fechaBuscada' ORDER BY id ASC LIMIT $desde,$porPagina ";
