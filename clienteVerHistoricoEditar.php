<?php
    ...
    if (isset($_POST['buscarHistorico'])) {
...
<link rel="stylesheet" type="text/css" href="stylesClientes.css">
    <div class="container">
        <div class="EditarClientesTitulo"><i class="fa-solid fa-address-book"></i> Ver clientes | Clientes: <?PHP echo $idCliente?> - Historico </div>
