...
<link rel="stylesheet" type="text/css" href="stylesReparto.css">
    <div class="container">
        <div class="EditarClientesTitulo"><i class="fa-solid fa-clipboard-list"></i> Reparto Martes3</div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_clientes FROM `clientes` WHERE pasado='0' AND reparto='Martes3' OR pasado='0' AND reparto2='Martes3'");
                                ...
                                $query = "SELECT * FROM clientes WHERE pasado='0' AND reparto='Martes3' OR pasado='0' AND reparto2='Martes3' ORDER BY numeroCLiente ASC LIMIT $desde,$porPagina";
