<?php
    ...
    if($mayorId!=NULL){
        ...
        $numeroDeCliente = doubleval($sqlQueryresult['idCliente']);
        $id = $sqlQueryresult['id'];
    ...
    $querySel = "SELECT * FROM clientes WHERE id=$numeroDeCliente";
    ...
    $sql_actualizarSaldo = "UPDATE clientes SET saldoAnteriorCliente=$saldoNuevoFinal WHERE id=$numeroDeCliente"; 
    $result_sql_actualizarSaldo = mysqli_query($conexion, $sql_actualizarSaldo);

    $queryUpd = "UPDATE clientes SET pasado=0 WHERE id='$idCliente'";
