...
<link rel="stylesheet" type="text/css" href="stylesReparto.css">
    <div class="container">
        <div class="EditarClientesTitulo"><i class="fa-solid fa-clipboard-list"></i> Reparto Viernes2</div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                    ...
                                    $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_clientes FROM `clientes` WHERE pasado='0' AND reparto='Viernes2' OR pasado='0' AND reparto2='Viernes2'");
                                ...
                                $query = "SELECT * FROM clientes WHERE pasado='0' AND reparto='Viernes2' OR pasado='0' AND reparto2='Viernes2' ORDER BY numeroCliente ASC LIMIT $desde,$porPagina";
