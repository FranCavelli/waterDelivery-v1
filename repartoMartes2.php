...
<link rel="stylesheet" type="text/css" href="stylesReparto.css">
    <div class="container">
        <div class="EditarClientesTitulo"><i class="fa-solid fa-clipboard-list"></i> Reparto Martes2</div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_clientes FROM `clientes` WHERE pasado='0' AND reparto='Martes2' OR pasado='0' AND reparto2='Martes2'");
                                ...
                                $query = "SELECT * FROM clientes WHERE pasado='0' AND reparto='Martes2' OR pasado='0' AND reparto2='Martes2' ORDER BY numeroCLiente ASC LIMIT $desde,$porPagina";
