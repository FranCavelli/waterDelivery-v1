...
<link rel="stylesheet" type="text/css" href="stylesReparto.css">
    <div class="container">
        <div class="EditarClientesTitulo"><i class="fa-solid fa-clipboard-list"></i> Reparto cuadrante 4</div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_clientes FROM `clientes` WHERE cuadrante='4'");
                                ...
                                $query = "SELECT * FROM clientes WHERE cuadrante='4' ORDER BY SUBSTRING(direccionCliente, -4)*1 ASC LIMIT $desde,$porPagina";
