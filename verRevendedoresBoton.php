...
<link rel="stylesheet" type="text/css" href="stylesRevendedores.css">
    <div class="container">
        <div class="EditarClientesTitulo"><i class="fa-solid fa-address-book"></i> Ver revendedores, codigo: <?php echo $idRevendedor?></div>
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="tarjetaa">
                    <form action="verRevendedoresBuscar.php" method="POST">
                        <div class="form-group">
                            <input type="text" name="idCliente" value="<?php echo $idRevendedor?>" class="ocultarElemento">
            ...
            <div class="columna8">
                    <table>
                        <thead>
                            <tr>
                                <th class="codigoClienteTablaHead">Nombre</th>
                                <th>X20</th>
                                <th>X12</th>
                                <th>X5</th>
                                <th>Sifones</th>
                        ...
                        <tbody>
                            <?php 
                                $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_revendedores FROM ventarevendedores WHERE idRevendedor='$idRevendedor'");
                                ...
                                $query = "SELECT * FROM ventarevendedores WHERE idRevendedor='$idRevendedor' ORDER BY id DESC LIMIT $desde,$porPagina";
