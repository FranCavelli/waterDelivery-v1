...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM clientes WHERE numeroCliente=$idCliente";
    ...
    $sqlP20 = "SELECT * FROM productos  WHERE idProducto = 1";
        ...
        $sql_actualizarSaldo = "UPDATE clientes SET saldoAnteriorCliente=$nuevoSaldoTotal WHERE numeroCliente=$idCliente"; 
