    ...
    <div class="container">
        ...
        <form action="repartoBuscar.php" method="get" class="formSearch">
            ...
            <select class="opcionesVerReparto" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
              ...
              <option value="repartoLunes2.php">Lunes2</option>
              <option value="repartoRuta.php">Ruta</option>
              <option value="repartoMartes.php">Martes</option>
              <option value="repartoMartes2.php">Martes2</option>
              <option value="repartoMartes3.php">Martes3</option>
              <option value="repartoMiercoles.php">Miercoles</option>
              <option value="repartoExGagliano.php">Ex gagliano</option>
              <option value="repartoJueves.php">Jueves</option>
              <option value="repartoJueves2.php">Jueves2</option>
              <option value="repartoJavierJueves.php">Javier jueves</option>
              <option value="repartoVierness.php">Viernes</option>
              <option value="repartoVierness2.php">Viernes2</option>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_clientes FROM `clientes` WHERE reparto='Lunes' OR reparto='Ruta' OR reparto='Martes' OR reparto='Martes2' OR reparto='Ex gagliano' OR reparto='Miercoles' OR reparto='Jueves' OR reparto='Javier jueves' OR reparto='Viernes' OR reparto='Viernes otro' OR reparto='Sabado' OR reparto='Javier Sabado' OR reparto='Agustin'");
                                ...
                                $query = "SELECT * FROM clientes WHERE reparto='Lunes' OR reparto='Ruta' OR reparto='Martes' OR reparto='Martes2' OR reparto='Ex gagliano' OR reparto='Miercoles' OR reparto='Jueves' OR reparto='Javier jueves' OR reparto='Viernes' OR reparto='Viernes otro' OR reparto='Sabado' OR reparto='Javier Sabado' OR reparto='Agustin' ORDER BY numeroCliente ASC LIMIT $desde,$porPagina";
                                ...
                                <tr <?php if($row['paraManana']=="Si"){
                                    ...
                                    <td style="background:#0ab92a;">
                                        <a href="cargarClienteGeneral.php?id=<?php echo $row['id']?>&pagina=<?php echo $pagina ?>" class="botonEliminar">Cargar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
