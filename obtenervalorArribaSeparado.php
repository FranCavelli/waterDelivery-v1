<?php 
    ...
    if(isset($_GET['id'])) {
        ...
        $query="SELECT * FROM clientes WHERE numeroCliente < '$numeroClienteMomento' AND reparto='$reparto' ORDER BY numeroCliente DESC LIMIT 1"; //Me da el de arriba
        ...
        if(mysqli_num_rows($resultado) > 0){
            ...
            $queryMomento = "UPDATE clientes SET numeroCliente='$numeroClienteMomento' WHERE id='$idCliente' AND reparto='$reparto'";
            $resultadoMomento= mysqli_query($conexion, $queryMomento);
    
            $queryDeseado = "UPDATE clientes SET numeroCliente='$numeroClienteDeseado' WHERE id='$idClienteDeseado' AND reparto='$reparto'";
