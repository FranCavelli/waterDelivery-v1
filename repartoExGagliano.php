...
<link rel="stylesheet" type="text/css" href="stylesReparto.css">
    <div class="container">
        <div class="EditarClientesTitulo"><i class="fa-solid fa-clipboard-list"></i> Reparto Ex Gagliano</div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                    ...
                                    $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_clientes FROM `clientes` WHERE pasado='0' AND reparto='Ex gagliano' OR pasado='0' AND reparto2='Ex gagliano' OR pasado='0' AND reparto='Exgagliano'");
                                ...
                                $query = "SELECT * FROM clientes WHERE pasado='0' AND reparto='Ex gagliano' OR pasado='0' AND reparto2='Ex gagliano' OR pasado='0' AND reparto='Exgagliano' ORDER BY numeroCliente ASC LIMIT $desde,$porPagina";
