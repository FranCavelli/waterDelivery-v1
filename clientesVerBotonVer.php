        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="tarjetaa">
                    ...
                    <form action="clienteVerHistoricoVer.php" method="POST">
                        <input type="text" name="idCliente" value="<?php echo $idCliente?>" class="ocultarElemento">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $query = "SELECT * FROM ventas WHERE idCliente='$idCliente' AND fecha='$fecha_year-$fecha_mes-$fecha_dia' ORDER BY id DESC LIMIT $desde,$porPagina";
